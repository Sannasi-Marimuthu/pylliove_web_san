...
<div className=" row y-gap-30 pt-40 sm:pt-20 item_gap-x30">
    ...
    {/* Unique selling proposition */}
      ...
      <div className="container  -w-1500 rounded-4 " style={{  marginTop: "20rem",borderRadius:"40px", backgroundColor:"#e6ffe6"}}>
        <div>
          <h1 style={{marginLeft:'20px', color:"#4b5e4b"}}>Unique Selling Proposition</h1>
        </div>
          ...
          <div>
            <div className="d-flex justify-content-evenly">
              <h4
                ...
                style={{ width: "40%", textAlign: "center" ,boxShadow: "2px 2px  #888888" }}
              >
                Single Price
              </h4>
              <h4
